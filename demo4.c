...
void createPlane(mesh* meshCube, float x, float y, float z, float size) {
    // SOUTH
    meshCube->tris[meshCube->counter++] = (struct triangle){{x, y, z, 1, x, y + size, z, 1, x + size, y + size, z, 1}};
    meshCube->tris[meshCube->counter++] = (struct triangle){{x, y, z, 1, x + size, y + size, z, 1, x + size, y, z, 1}};
}
...
//j
createPlane(&meshCube, -3.0f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, -3.0f, 0.5f, 3.0f, 0.5f);
createPlane(&meshCube, -3.5f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -4.0f, 0.5f, 3.0f, 0.5f);
createPlane(&meshCube, -3.0f, -0.5f, 3.0f, 0.5f);
createPlane(&meshCube, -3.0f, -1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -3.5f, -1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -4.0f, -1.0f, 3.0f, 0.5f);

//e
createPlane(&meshCube, -2.0f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, -1.5f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, -1.0f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, -2.0f, 0.5f, 3.0f, 0.5f);
createPlane(&meshCube, -2.0f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -1.5f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -1.0f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -2.0f, -0.5f, 3.0f, 0.5f);
createPlane(&meshCube, -2.0f, -1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -1.5f, -1.0f, 3.0f, 0.5f);
createPlane(&meshCube, -1.0f, -1.0f, 3.0f, 0.5f);
...
//b
createPlane(&meshCube, 0.0f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, 0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f, 0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, -0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f, -0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, -1.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f, -1.0f, 3.0f, 0.5f);
...
createPlane(&meshCube, 2.0f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, 2.0f, -0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 2.5f, -1.0f, 3.0f, 0.5f);
createPlane(&meshCube, 2.5f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, 3.0f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, 3.0f, 0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 3.0f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, 3.0f, -0.5f, 3.0f, 0.5f);
...
//c
createPlane(&meshCube, 4.0f, 0.0f, 3.0f, 0.5f);
createPlane(&meshCube, 4.0f, 0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 4.5f, 1.0f, 3.0f, 0.5f);
createPlane(&meshCube, 4.0f, -0.5f, 3.0f, 0.5f);
createPlane(&meshCube, 4.5f, -1.0f, 3.0f, 0.5f);


//b
createPlane(&meshCube, 0.0f, 0.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f, 0.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, 0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f, 0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, 1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f, 1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, -0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f, -0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f, -1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f, -1.0f+3.0f, 3.0f, 0.5f);
...
//b
//createPlane(&meshCube, 0.0f+2.0f, 0.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f+2.0f, 0.0f+3.0f, 3.0f, 0.5f);
//createPlane(&meshCube, 0.0f+2.0f, 0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f+2.0f, 0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f+2.0f, 1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f+2.0f, 1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f+2.0f, -0.5f+3.0f, 3.0f, 0.5f);
//createPlane(&meshCube, 1.0f+2.0f, -0.5f+3.0f, 3.0f, 0.5f);
//createPlane(&meshCube, 0.0f+2.0f, -1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f+2.0f, -1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f+2.0f, -1.0f+3.0f, 3.0f, 0.5f);

//d
createPlane(&meshCube, 0.0f+4.0f, 0.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f+4.0f, 0.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f+4.0f, 0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f+4.0f, 0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f+4.0f, 1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f+4.0f, 1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f+4.0f, -0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 1.0f+4.0f, -0.5f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.0f+4.0f, -1.0f+3.0f, 3.0f, 0.5f);
createPlane(&meshCube, 0.5f+4.0f, -1.0f+3.0f, 3.0f, 0.5f);
...
while(true){
    ...
    if(fpsI == fps){
        ...
        if(GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_7) == GPIO_PIN_7){ yaw += 1.0f * fElapsedTime;}
        if(GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_6) == GPIO_PIN_6){ yaw -= 1.0f * fElapsedTime;}
